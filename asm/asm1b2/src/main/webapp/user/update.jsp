...
<form method="post">
    ...
    <div class="mb-3">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" value="Nam"
                   name="gender" ${user.gender == 'Nam' ? 'checked' : ''} id="flexRadioDefault1">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" value="Nữ"
                   name="gender" ${user.gender == 'Nữ' ? 'checked' : ''} id="flexRadioDefault2">
    ...
    <button formaction="/asm_1_war_exploded/update" type="submit" class="btn btn-primary">Save</button>
</form>
</body>
</html>
