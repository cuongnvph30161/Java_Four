...
<form method="post"  enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="image" class="form-control" id="fulllname">
    </div>

    <button formaction="addVideo" type="submit" class="btn btn-primary">Submit</button>
</form>
</body>
</html>
