...
public class HibernateUtil {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://;serverName=103.124.94.100;databaseName=PTPM_FINALLY_JAVA_SOF3011;encrypt=true;trustServerCertificate=true");
